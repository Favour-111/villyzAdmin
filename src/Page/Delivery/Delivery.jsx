        ...
        <div className="p-4">
          <div className="product-body shadow">
            <div className="d-flex align-items-center gap-2 actionIcons">
              ...
              <div className="tips">
                Tip search by delivery location: Each locaion is provided with a
                unique name, which you can rely on to find the exact product you
                need.
              </div>
            </div>
